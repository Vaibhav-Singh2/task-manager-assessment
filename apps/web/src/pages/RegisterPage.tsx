...
export const RegisterPage = () => {
  ...
  const { name, setName, email, setEmail, password, setPassword, error, loading, onSubmit } = useAuthForm('register');
  ...
  return (
    <div className="min-h-screen flex items-stretch">
      ...
      <section className="hidden lg:flex lg:w-1/2 relative editorial-gradient overflow-hidden items-center justify-center p-margin-desktop">
        ...
        <div className="relative z-10 max-w-xl">
          ...
          <h1 className="font-display-lg text-display-lg text-on-primary-container mb-stack-md leading-tight">
            Join the <span className="text-primary italic">Editorial Team</span>
          </h1>
      ...
      <main className="w-full lg:w-1/2 flex flex-col items-center justify-center bg-surface p-margin-mobile md:p-margin-desktop relative">
        ...
        <div className="w-full max-w-sm flex flex-col space-y-stack-lg mt-8">
          <header className="space-y-base">
            <h2 className="font-headline-lg text-headline-lg text-on-surface lg:text-left text-center">Create Account</h2>
            <p className="font-body-md text-body-md text-on-surface-variant lg:text-left text-center">Sign up for your editorial workspace.</p>
          </header>
          ...
          <form onSubmit={submit} className="space-y-stack-md">
            ...
            <div className="space-y-base">
              <label className="font-label-sm text-label-sm text-on-surface-variant uppercase ml-1" htmlFor="name">Full Name</label>
          ...
          <footer className="pt-stack-lg text-center">
            <p className="font-body-md text-body-md text-on-surface-variant">
              ...
              <Link className="text-primary font-semibold ml-1 hover:underline underline-offset-4" to="/login">Sign In</Link>
            </p>
          </footer>
        </div>
